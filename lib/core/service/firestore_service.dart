...
class FireStoreService implements DatabaseService {
 ...
 FirebaseStorage storage = FirebaseStorage.instance;
  ...
  @override
  Future<List<UserInformationsEntity>> fetchAllDecuments(String collectionName) async {
    try {
  ...
  @override
Future<String> uploadImage({required File image, required String path}) async {
  try {
